...
## Current milestone
M2 — the social game. Take the lowest-numbered unclaimed card in `docs/tasks/M2-*.md`. M2-00 is a design-and-owner-decision card and must land before implementation cards begin.
