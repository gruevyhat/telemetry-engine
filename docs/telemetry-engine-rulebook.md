...
There is no game master. There may or may not be a traitor. There is definitely a payment.

The engine runs **four pillars** — four kinds of trouble your ship can be pointed at, freely mixed within one campaign:
...
**MAGGIE is the referee.** She frames scenes, prices deals, fields enemies, keeps every record, and adjudicates every roll. She is scrupulously neutral and slightly judgmental. When she rolls for the world, her dice appear on the shared screen. When she rolls in secret, she says so, openly. You will always know *that* a secret exists. Rarely what.

**You roll your own dice.** Physical dice, on the table, in front of everyone. MAGGIE never touches a player's fate directly; she only prices it.
...
**Envelopes hold what you are.** One sealed envelope per player. It may contain a hidden agenda. It may contain only a personal secret. *All, some, or none* of you may be working for someone else. MAGGIE knows the count. She is not telling.
...
![Shared screen wireframe](te-wireframe-shared.svg)
...
![Phone wireframe](te-wireframe-phone.svg)
...
**Step 3 — Linking events.** MAGGIE announces connections: *"Zhan and Deuce: you served together at the Solee blockade. It ended badly. Sixty seconds — decide what went wrong."* Your two-sentence version becomes canon. Lie if you like. It's logged either way.

**Step 4 — The ship and the frame.** MAGGIE presents your vessel, its jump rating, and the campaign frame — which pillar leads, what the Obligation is, and the published **agenda odds** (trade runs low; espionage runs high; you always know the odds, never the outcome). One player is elected **captain** — tie-breaker, fall-taker, replaceable by vote.

**Step 5 — Envelopes and objectives.** MAGGIE prints each player's sealed packet: a **private objective** for everyone, and — per the published odds, rolled independently and in secret — possibly an **agenda**: a faction, a payout, and quiet work against the crew's interest. Read privately. Seal it. Say nothing.
...
![Confrontation flow](te-confrontation.svg)
